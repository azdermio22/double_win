<x-layout>
    <div class="filter_pannel pannel_mouvment">
        ...
        <form class="d-flex flex-column justify-content-center px-4" method="POST" action="{{route('filtra')}}">
            @csrf
        <input class="my-3" name="serch" type="serch" id="serch" value="{{$selected_filter[0]}}">
        <select class="d-block my-4" name="categori" id="categori">
        ...
        <select class="d-block my-4" name="orderby" id="orderby">
        ...
        <select class="d-block my-4" name="order" id="order">
        ...
        <div class="my-5 position-relative">
            ...
            <input class="range w-100" name="range" type="range" min="{{$min}}" max="{{$max}}" @if ($selected_filter[1]) value="{{$selected_filter[1]}}" @else value="{{$max}}" @endif id="range">
        </div>
        <input hidden id="remove" name="remove" type="number">
